...
if __name__ == "__main__":
    ...
    event_nn.model.save(DIR + 'event_nn.h5')
...
params_signif = {'title' : ('Significance plot for the feedforward neural '
                              'network trained on ttH event data'),
...
fig.savefig(DIR + 'op_threshold_confusion_matrix.pdf')
...
# fig_sig = plotlib.significance(sig_x, sig_y, params_signif)
