...
fig1 = plotlib.training_history_plot(history, 'Event neural network model accuracy', dpi=100)
# fig1.savefig('\\Users\\user\\Documents\\Fifth Year\\invisible-higgs\\Images\\complete_neural_network\\multi_signal_complete_accuracy.png')
...
# fig2.savefig('\\Users\\user\\Documents\\Fifth Year\\invisible-higgs\\Images\\complete_neural_network\\multi_signal_complete_roc_curve.png')
...
fig3 = plotlib.confusion_matrix(cm, class_names, title, dpi=100)
# fig3.savefig('\\Users\\user\\Documents\\Fifth Year\\invisible-higgs\\Images\\complete_neural_network\\multi_signal_complete_confusion_matrix.png')
